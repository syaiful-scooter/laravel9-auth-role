...
<body>
	<div class="wrapper">
		<!-- <nav class="sidebar">
			<div class="sidebar-content ">
				...
				<div class="sidebar-bottom d-none d-lg-block">
					<div class="media">
						<img class="rounded-circle mr-3" src="{{asset('assets_appstack/img/avatars/avatar.jpg')}}" alt="Chris Wood" width="40" height="40">
		...
		@include('appstacklayouts.sidebar')
		...
		<div class="main d-flex flex-column">
			...
			@include('appstacklayouts.footer')
		</div>
	</div>
